        ...
        >
            ...
            {industries.map((item) => {
              ...
              return (
                <div
                  ...
                  className="flex items-start gap-2 ml-2.5 cursor-pointer group"
                >
                  <div
                    className={`
                  h-8 w-[5px] rounded-full transition-colors duration-300
                  ${
                    isActive ? "bg-orange-500" : "bg-gray-300 dark:bg-slate-500"
                  }
                `}
                  />
                  <h1
          ...
          <div className="flex flex-col w-full gap-3 md:w-[840px]">
            <div className="w-full px-2 pb-4">
              <p className="font-quicksand text-2xl leading-9 text-gray-700 dark:text-gray-300">
                {active.desc}
              </p>
            </div>
